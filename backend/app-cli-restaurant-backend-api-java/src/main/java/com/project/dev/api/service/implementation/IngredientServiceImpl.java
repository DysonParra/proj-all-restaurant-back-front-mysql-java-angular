/*
 * @overview        {IngredientServiceImpl}
 *
 * @version         2.0
 *
...
/**
 * TODO: Description of {@code IngredientServiceImpl}.
 *
 * @author Dyson Parra
...
public class IngredientServiceImpl implements GenericService<IngredientDTO> {
    ...
    private final IngredientMapping entityMapping = Mappers.getMapper(IngredientMapping.class);
     ...
     */
    public IngredientServiceImpl(IngredientRepository entityRepository) {
    ...
    public Page<IngredientDTO> getAllEntitiesPaged(Pageable pageable) throws Exception {
        log.debug("Solicitud para listar todas las Entidades tipo Ingredient con paginación");
     ...
     */
    @Override
    public IngredientDTO saveUpdate(IngredientDTO entityDTO) throws Exception {
        log.debug("Solicitud para guardar la entidad tipo Ingredient: {}", entityDTO);

        //TODO: agregar validación específica del servicio.
        Ingredient entity = entityMapping.getEntity(entityDTO);
        entity = entityRepository.save(entity);

        IngredientDTO dto = entityMapping.getDto(entity);
        return dto;
    }
     ...
     */
    @Override
    public IngredientDTO getEntity(String id) throws Exception {
    ...
    public void deleteEntity(String id) throws Exception {
        log.debug("Solicitud para eliminar la entidad tipo Ingredient: {}", id);
