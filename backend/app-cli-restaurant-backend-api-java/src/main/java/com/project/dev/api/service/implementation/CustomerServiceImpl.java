...
/**
 * TODO: Description of {@code CustomerServiceImpl}.
 *
 * @author Dyson Parra
...
public class CustomerServiceImpl implements GenericService<CustomerDTO> {
    ...
    public Page<CustomerDTO> getAllEntitiesPaged(Pageable pageable) throws Exception {
        log.debug("Solicitud para listar todas las Entidades tipo Customer con paginación");
    ...
    public CustomerDTO saveUpdate(CustomerDTO entityDTO) throws Exception {
        ...
        CustomerDTO dto = entityMapping.getDto(entity);
        return dto;
    }
