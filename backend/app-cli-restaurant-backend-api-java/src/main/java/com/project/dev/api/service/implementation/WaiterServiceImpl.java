...
import com.project.dev.api.repository.WaiterRepository;
import com.project.dev.api.service.GenericService;
import com.project.dev.api.service.exception.EntityNotFoundException;
import com.project.dev.api.service.mapping.WaiterMapping;
...
/**
 * TODO: Description of {@code WaiterServiceImpl}.
 *
 * @author Dyson Parra
...
public class WaiterServiceImpl implements GenericService<WaiterDTO> {

    private final Logger log = LoggerFactory.getLogger(WaiterServiceImpl.class);
    private final WaiterRepository entityRepository;
    private final WaiterMapping entityMapping = Mappers.getMapper(WaiterMapping.class);
     ...
     */
    public WaiterServiceImpl(WaiterRepository entityRepository) {
    ...
    public Page<WaiterDTO> getAllEntitiesPaged(Pageable pageable) throws Exception {
        log.debug("Solicitud para listar todas las Entidades tipo Waiter con paginación");
     ...
     */
    @Override
    public WaiterDTO saveUpdate(WaiterDTO entityDTO) throws Exception {
        log.debug("Solicitud para guardar la entidad tipo Waiter: {}", entityDTO);

        //TODO: agregar validación específica del servicio.
        Waiter entity = entityMapping.getEntity(entityDTO);
        entity = entityRepository.save(entity);

        WaiterDTO dto = entityMapping.getDto(entity);
        return dto;
    }
     ...
     */
    @Override
    public WaiterDTO getEntity(String id) throws Exception {
    ...
    public void deleteEntity(String id) throws Exception {
        log.debug("Solicitud para eliminar la entidad tipo Waiter: {}", id);
