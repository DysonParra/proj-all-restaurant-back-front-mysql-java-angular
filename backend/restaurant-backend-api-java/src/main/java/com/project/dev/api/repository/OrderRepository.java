...
/**
 * TODO: Definición de {@code OrderRepository}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public interface OrderRepository extends JpaRepository<Order, Long> {
     ...
     */
    public List<Order> findByIntOrderId(Long id);
    ...
    @Query("SELECT m FROM Order m WHERE m.intOrderId LIKE CONCAT('%', :strSearch, '%')")
    public List<Order> searchEntities(@Param("strSearch") String strSearch);
    ...
    // TODO: Especificar campo de la entidad donde realizar la búsqueda.
    @Query("SELECT m FROM Order m WHERE m.intOrderId LIKE CONCAT('%', :strSearch, '%')")
    public Page<Order> searchEntities(@Param("strSearch") String strSearch, Pageable pageable);
}
