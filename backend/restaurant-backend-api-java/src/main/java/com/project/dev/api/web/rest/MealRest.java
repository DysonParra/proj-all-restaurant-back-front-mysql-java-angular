...
public class MealRest {
    ...
    public ResponseEntity<List<MealDTO>> getAllEntitiesPaged(Pageable pageable) {
    ...
    public ResponseEntity<List<MealDTO>> searchEntitiesPaged(@PathVariable String query, Pageable pageable) {
