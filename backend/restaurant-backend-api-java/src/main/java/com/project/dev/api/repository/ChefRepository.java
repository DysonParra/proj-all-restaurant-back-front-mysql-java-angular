...
/**
 * TODO: Definición de {@code ChefRepository}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public interface ChefRepository extends JpaRepository<Chef, Long> {
     ...
     */
    public List<Chef> findByIntChefId(Long id);
    ...
    @Query("SELECT m FROM Chef m WHERE m.intChefId LIKE CONCAT('%', :strSearch, '%')")
    public List<Chef> searchEntities(@Param("strSearch") String strSearch);
    ...
    // TODO: Especificar campo de la entidad donde realizar la búsqueda.
    @Query("SELECT m FROM Chef m WHERE m.intChefId LIKE CONCAT('%', :strSearch, '%')")
    public Page<Chef> searchEntities(@Param("strSearch") String strSearch, Pageable pageable);
}
