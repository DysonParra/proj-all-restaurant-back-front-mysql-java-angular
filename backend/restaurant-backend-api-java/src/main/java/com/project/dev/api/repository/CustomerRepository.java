/*
 * @fileoverview    {CustomerRepository} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
/**
 * TODO: Definición de {@code CustomerRepository}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public interface CustomerRepository extends JpaRepository<Customer, Long> {
     ...
     */
    public List<Customer> findByIntCustomerId(Long id);
    ...
    @Query("SELECT m FROM Customer m WHERE m.intCustomerId LIKE CONCAT('%', :strSearch, '%')")
    public List<Customer> searchEntities(@Param("strSearch") String strSearch);
    ...
    // TODO: Especificar campo de la entidad donde realizar la búsqueda.
    @Query("SELECT m FROM Customer m WHERE m.intCustomerId LIKE CONCAT('%', :strSearch, '%')")
    public Page<Customer> searchEntities(@Param("strSearch") String strSearch, Pageable pageable);
}
