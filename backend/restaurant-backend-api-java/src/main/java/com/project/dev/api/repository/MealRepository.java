...
/**
 * TODO: Definición de {@code MealRepository}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public interface MealRepository extends JpaRepository<Meal, Long> {
     ...
     */
    public List<Meal> findByIntMealId(Long id);
    ...
    @Query("SELECT m FROM Meal m WHERE m.intMealId LIKE CONCAT('%', :strSearch, '%')")
    public List<Meal> searchEntities(@Param("strSearch") String strSearch);
    ...
    // TODO: Especificar campo de la entidad donde realizar la búsqueda.
    @Query("SELECT m FROM Meal m WHERE m.intMealId LIKE CONCAT('%', :strSearch, '%')")
    public Page<Meal> searchEntities(@Param("strSearch") String strSearch, Pageable pageable);
}
