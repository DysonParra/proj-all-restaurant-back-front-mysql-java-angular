/*
 * @fileoverview    {ProviderRepository} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
/**
 * TODO: Definición de {@code ProviderRepository}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public interface ProviderRepository extends JpaRepository<Provider, Long> {
     ...
     */
    public List<Provider> findByIntProviderId(Long id);
    ...
    @Query("SELECT m FROM Provider m WHERE m.intProviderId LIKE CONCAT('%', :strSearch, '%')")
    public List<Provider> searchEntities(@Param("strSearch") String strSearch);
    ...
    // TODO: Especificar campo de la entidad donde realizar la búsqueda.
    @Query("SELECT m FROM Provider m WHERE m.intProviderId LIKE CONCAT('%', :strSearch, '%')")
    public Page<Provider> searchEntities(@Param("strSearch") String strSearch, Pageable pageable);
}
