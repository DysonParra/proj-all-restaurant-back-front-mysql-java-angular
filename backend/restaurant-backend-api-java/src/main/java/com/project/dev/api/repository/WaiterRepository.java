...
/**
 * TODO: Definición de {@code WaiterRepository}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public interface WaiterRepository extends JpaRepository<Waiter, Long> {
     ...
     */
    public List<Waiter> findByIntWaiterId(Long id);
    ...
    @Query("SELECT m FROM Waiter m WHERE m.intWaiterId LIKE CONCAT('%', :strSearch, '%')")
    public List<Waiter> searchEntities(@Param("strSearch") String strSearch);
    ...
    // TODO: Especificar campo de la entidad donde realizar la búsqueda.
    @Query("SELECT m FROM Waiter m WHERE m.intWaiterId LIKE CONCAT('%', :strSearch, '%')")
    public Page<Waiter> searchEntities(@Param("strSearch") String strSearch, Pageable pageable);
}
