...
/**
 * TODO: Definición de {@code SupplierRepository}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public interface SupplierRepository extends JpaRepository<Supplier, Long> {
     ...
     */
    public List<Supplier> findByIntSupplierId(Long id);
    ...
    @Query("SELECT m FROM Supplier m WHERE m.intSupplierId LIKE CONCAT('%', :strSearch, '%')")
    public List<Supplier> searchEntities(@Param("strSearch") String strSearch);
    ...
    // TODO: Especificar campo de la entidad donde realizar la búsqueda.
    @Query("SELECT m FROM Supplier m WHERE m.intSupplierId LIKE CONCAT('%', :strSearch, '%')")
    public Page<Supplier> searchEntities(@Param("strSearch") String strSearch, Pageable pageable);
}
