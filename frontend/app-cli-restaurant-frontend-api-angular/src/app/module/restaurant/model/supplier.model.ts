/*
 * @fileoverview    {SupplierViewModel}
 *
 * @version         2.0
 *
...
/**
 * TODO: Description of {@code SupplierViewModel}.
 *
 * @author Dyson Parra
...
export class SupplierViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public intSupplierId: number;
    public strSupplierCity: string;
    public txtSupplierName: string;
    public intPhone: number;
    public intChefId: number;

    /**
     * TODO: Description of method {@code newEntity}.
     *
     */
    public newEntity(): SupplierViewModel {
