...
/**
 * TODO: Description of {@code MealViewModel}.
 *
 * @author Dyson Parra
...
export class MealViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public intMealId: number;
    public strName: string;
    public fltPrice: number;
     ...
     *
     */
    public newEntity(): MealViewModel {
