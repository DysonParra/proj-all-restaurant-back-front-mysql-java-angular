...
/**
 * TODO: Description of {@code ChefViewModel}.
 *
 * @author Dyson Parra
...
export class ChefViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public intChefId: number;
    public strChefName: string;
     ...
     *
     */
    public newEntity(): ChefViewModel {
