...
/**
 * TODO: Description of {@code WaiterViewModel}.
 *
 * @author Dyson Parra
...
export class WaiterViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public intWaiterId: number;
    public strWaiterName: string;
    public fltSalary: number;
     ...
     *
     */
    public newEntity(): WaiterViewModel {
