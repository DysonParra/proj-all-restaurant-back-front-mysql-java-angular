/*
 * @fileoverview    {CustomerViewModel}
 *
 * @version         2.0
 *
...
/**
 * TODO: Description of {@code CustomerViewModel}.
 *
 * @author Dyson Parra
...
export class CustomerViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public intCustomerId: number;
    public strCustomerName: string;
    public strAddress: string;
    public intPhone: number;
    public intWaiterId: number;

    /**
     * TODO: Description of method {@code newEntity}.
     *
     */
    public newEntity(): CustomerViewModel {
