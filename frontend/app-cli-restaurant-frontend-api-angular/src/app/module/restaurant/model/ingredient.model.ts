/*
 * @fileoverview    {IngredientViewModel}
 *
 * @version         2.0
 *
...
/**
 * TODO: Description of {@code IngredientViewModel}.
 *
 * @author Dyson Parra
...
export class IngredientViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public intIngredientId: number;
    public strIngredientName: string;
    public strDescription: string;
    public intMealId: number;

    /**
     * TODO: Description of method {@code newEntity}.
     *
     */
    public newEntity(): IngredientViewModel {
