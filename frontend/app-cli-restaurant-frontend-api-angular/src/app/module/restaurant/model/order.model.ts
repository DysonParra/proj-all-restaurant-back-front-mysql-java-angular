...
/**
 * TODO: Description of {@code OrderViewModel}.
 *
 * @author Dyson Parra
...
export class OrderViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public intOrderId: number;
     ...
     *
     */
    public newEntity(): OrderViewModel {
