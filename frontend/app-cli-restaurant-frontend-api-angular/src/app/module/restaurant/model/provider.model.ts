...
/**
 * TODO: Description of {@code ProviderViewModel}.
 *
 * @author Dyson Parra
...
export class ProviderViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public intProviderId: number;
     ...
     *
     */
    public newEntity(): ProviderViewModel {
